...
| Bestand | Gebruik |
| --- | --- |
| `01.mp3` t/m `20.mp3` | Getal aantikken; hardop tellen bij een juist antwoord in alle modi, bij een fout antwoord in de audiomodi |
...
| `goed geteld.mp3` | Na de telwoorden bij een goed antwoord in alle modi |
