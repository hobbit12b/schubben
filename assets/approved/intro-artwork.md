...
The listening and combined choices play the existing `audio/voice/03.mp3` recording when selected. The seeing choice stops the preview. Starting the game cancels the preview before the introduction. All three modes and all four levels remain directly available on the intro.
