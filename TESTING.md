...
`node tests/turns.cjs` controleert 101 standen per draai in beide richtingen: geen schaal die nul wordt, doorlopende zichtbaarheid, opruimen van de tijdelijke laag en echt opgenomen telwoorden bij een juist antwoord in de visuele modus.
De turns-test bemonstert ook elk renderframe direct na klikken op Regenboog bij een fout antwoord; de twee gezichtsafbeeldingen blijven samen zichtbaar.
